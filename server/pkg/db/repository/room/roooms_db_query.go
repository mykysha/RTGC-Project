...
import (
	...
	"github.com/nndergunov/RTGC-Project/server/pkg/db/internal/rtgc/public/table"
)
...
func listRoomsQuery(listOptions *db2.ListOptions, criteria *db2.RoomsCriteria) pg.SelectStatement {

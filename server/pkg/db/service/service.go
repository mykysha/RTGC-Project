...
import (
	...
	db "github.com/nndergunov/RTGC-Project/server/pkg/db/internal/rtgc/public"
	model2 "github.com/nndergunov/RTGC-Project/server/pkg/db/internal/rtgc/public/model"
	rrep "github.com/nndergunov/RTGC-Project/server/pkg/db/repository/room"
	urep "github.com/nndergunov/RTGC-Project/server/pkg/db/repository/user"
)
...
func (s ServiceDB) ReadAllRooms() ([]*model2.Rooms, error) {
...
func (s ServiceDB) ReadAllUsers() ([]*model2.Usersinroom, error) {
